Http calls are 4 types
    ...
    3) Define the route.
    4) Create the route instance attach the port to the server
        that to be created.



Once you create "http" server you need to create http handler
...
Unmarshal - convert json to go lang object
